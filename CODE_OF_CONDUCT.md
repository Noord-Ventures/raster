...
Report instances of abusive, harassing, or otherwise unacceptable behaviour to the maintainers through a private report on the repository (Security → Report a vulnerability works for conduct reports too; mark it as a conduct report) or by contacting a maintainer directly. All complaints will be reviewed and investigated promptly and fairly. Maintainers are obligated to respect the privacy and security of the reporter.
