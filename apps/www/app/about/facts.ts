...
export const lead = {
  ...
  who: "It is meant for product UI: forms, tables, settings, the everyday catalogue. You install the CSS. React is there if you want a component. The classes start with rs-.",
};
...
export const specimen = {
  ...
  mid: "A button is 40 tall on the desktop and 44 on the phone. The field label sits on a 16px line so the hairline lands on an integer. Radius on a control follows the concentric law. Raster chrome stays square.",
...
export const history = {
  kicker: "History",
  body: "The programme comes from Swiss Style and Dutch modernism. Josef Müller-Brockmann drew it. Wim Crouwel put it on the press at Total Design.",
};
...
export const programme = {
  ...
  hairline: {
    kicker: "Hairlines",
    law: "The programme is visible. A 1px line, not a box.",
  },
  flush: {
    kicker: "Flush · 0",
