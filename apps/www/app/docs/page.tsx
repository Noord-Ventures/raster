...
import { COMMAND, HOST, LAW } from "../specimen";
      ...
      <div className="site-layout">
        ...
        <main className="site-content">
          <header className="cover" style={{ paddingBottom: 8 }}>
            ...
            <p className="rs-t-sub">CSS you own.</p>
          </header>
        ...
        <p className="rs-t-body">
          ...
          <code className="rs-code">index.html</code> (a specimen page), and{" "}
        ...
        <p className="rs-t-body">
          ...
          no code; the classes are already in raster.css, and{" "}
          <code className="rs-code">add</code> prints the markup.
        </p>
