...
| --- | --- | --- | --- |
| Specimen | `/` | Logo, or the site root | Scrollable 204 field. Opens into the viewport — no outer frame on top, left, right, or bottom. Hero word is Raster, set in Inter. Law is “A design system on a modular grid.” Install command is a primary CTA (before the numbered laws, poster size, copy control). “A poster you can install.” is demoted. Numbered laws. Full kit cells (accordion, calendar, field, stepper). Internal hairlines stay. |
