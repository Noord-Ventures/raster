...
export const rasterComponents: RasterComponent[] = [
  ...
  },
  {
    ...
    snippet: `<form style="display:flex;flex-direction:column;gap:16px;max-width:388px"><div class="rs-field"><span class="rs-field-label">Name</span><input class="rs-input rs-input-full" /></div><div class="rs-field"><span class="rs-field-label">E-mail</span><input class="rs-input rs-input-full" /></div><button class="rs-btn-primary">Send</button></form>`,
  },
  {
    name: "workflow",
    title: "Workflow card",
