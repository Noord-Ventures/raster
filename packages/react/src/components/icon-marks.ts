...
export const marks: Record<DrawnName, MarkEl[]> = {
  ...
  compass: [o(8, 8, 5.5), p("M8 3.5 L9.5 9.5 L8 8 L6.5 9.5 Z")],
  map: [
  ...
  "thumbs-up": [p("M4 8 V13 H6 V8 Z"), p("M6 8 H12 L11 12.5 H6"), p("M7.5 8 V4.5 H9.5 L10 8")],
  slash: [p("M5 13 L11 3")],
  equal: [p("M3.5 6 H12.5"), p("M3.5 10 H12.5")],
  box: [r(3.5, 3.5, 9, 9)],
  truck: [r(2.5, 5.5, 8, 5.5), p("M10.5 7 H13.5 V11 H10.5"), o(5.5, 12.5, 1.2), o(12, 12.5, 1.2)],
  activity: [p("M2.5 8 H5 L7 4 L9 12 L11 8 H13.5")],
  crosshair: [o(8, 8, 3.5), p("M8 2.5 V4.5"), p("M8 11.5 V13.5"), p("M2.5 8 H4.5"), p("M11.5 8 H13.5")],
  pin: [p("M8 2.5 L10.5 8 H5.5 Z"), p("M8 8 V13.5")],
};
