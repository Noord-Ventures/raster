...
export const marks: Record<DrawnName, MarkEl[]> = {
  ...
  /* Navigation — optical box ~3–13, center 8,8 */
  "arrow-left": [p("M12.5 8 H3.5"), p("M7 4.5 L3.5 8 L7 11.5")],
  "arrow-right": [p("M3.5 8 H12.5"), p("M9 4.5 L12.5 8 L9 11.5")],
  "arrow-up": [p("M8 12.5 V3.5"), p("M4.5 7 L8 3.5 L11.5 7")],
  "arrow-down": [p("M8 3.5 V12.5"), p("M4.5 9 L8 12.5 L11.5 9")],
  ...
  home: [p("M3 8 L8 3.5 L13 8"), p("M5 8 V13 H7 V10 H9 V13 H11 V8")],
  ...
  search: [o(7, 7, 4), p("M10.2 10.2 L13.5 13.5")],
  filter: [p("M3.5 3.5 H12.5 L9.5 8 V12.5 L6.5 13.5 V8 Z")],
  sort: [p("M3.5 5 H12.5"), p("M3.5 8 H10"), p("M3.5 11 H7.5")],
  edit: [p("M10 3.5 L12.5 6 L5.5 13 H3.5 V11 Z")],
  trash: [
    p("M5 4 H11"),
    p("M6.5 4 V3 H9.5 V4"),
  ...
  share: [o(4, 8, 1.25), o(12, 4.5, 1.25), o(12, 11.5, 1.25), l(5.15, 7.35, 10.85, 5.15), l(5.15, 8.65, 10.85, 10.85)],
  download: [p("M3.5 11 V13 H12.5 V11"), p("M8 3.5 V10.5"), p("M5.5 8 L8 10.5 L10.5 8")],
  upload: [p("M3.5 11 V13 H12.5 V11"), p("M8 10.5 V3.5"), p("M5.5 6 L8 3.5 L10.5 6")],
  refresh: [p("M4.2 6.2 A4.5 4.5 0 1 0 8 3.5"), p("M8 3.5 L10.2 3.5 L8.6 5.6")],
  undo: [p("M5 8 A4 4 0 1 0 8 4.5"), p("M5 8 L5 5.2 L7.6 5.2")],
  redo: [p("M11 8 A4 4 0 1 1 8 4.5"), p("M11 8 L11 5.2 L8.4 5.2")],
  save: [p("M3.5 3.5 H10.5 L12.5 5.5 V12.5 H3.5 Z"), r(5.5, 3.5, 5, 3), r(5.5, 9, 5, 3.5)],
  "zoom-in": [o(7, 7, 4), p("M10.2 10.2 L13.5 13.5"), p("M7 5 V9"), p("M5 7 H9")],
  "zoom-out": [o(7, 7, 4), p("M10.2 10.2 L13.5 13.5"), p("M5 7 H9")],
  ...
  bell: [p("M8 3 L10.5 5.5 V8.5 L12 11.5 H4 L5.5 8.5 V5.5 Z"), p("M7 12.5 H9")],
  send: [p("M2.5 3 L13.5 8 L2.5 13 L5.5 8 Z"), p("M5.5 8 H13.5")],
  inbox: [p("M3 6.5 V12.5 H13 V6.5"), p("M3 6.5 L6.5 10 H9.5 L13 6.5")],
  reply: [p("M8 3.5 L3.5 8 L8 12.5"), p("M3.5 8 H11 V5")],
  ...
  mic: [r(6, 2.5, 4, 7), p("M4.5 9 A3.5 3.5 0 0 0 11.5 9"), p("M8 12.5 V13.5"), p("M6 13.5 H10")],
  ...
  cog: [
    ...
    p("M11.8 8 H13.5"),
    p("M4.1 4.1 L5.3 5.3"),
    p("M10.7 10.7 L11.9 11.9"),
    p("M11.9 4.1 L10.7 5.3"),
    p("M5.3 10.7 L4.1 11.9"),
  ],
  ...
  "map-pin": [o(8, 6.5, 3.2), p("M5.4 8.6 L8 13.5 L10.6 8.6")],
  globe: [o(8, 8, 5.5), p("M8 2.5 V13.5"), p("M2.5 8 H13.5"), p("M4 5.2 H12"), p("M4 10.8 H12")],
  ...
  cut: [o(5, 11.5, 1.5), o(11, 11.5, 1.5), p("M5 10 L11 3.5"), p("M11 10 L5 3.5")],
  paste: [r(4.5, 4.5, 8, 9), r(6, 2.5, 5, 2.5), p("M6.5 8 H10.5")],
  ...
  "user-check": [o(6, 5.5, 1.75), p("M2.5 13 V12 L6 10.5 L9.5 12 V13"), p("M10 8.5 L11.5 10 L14.5 6.5")],
  "file-plus": [
    p("M5 2.5 H9.5 L12.5 5.5 V13.5 H5 Z"),
    p("M9.5 2.5 V5.5 H12.5"),
    p("M8 8 V12"),
  ...
  "folder-plus": [p("M2.5 5.5 H6 L7.5 4 H13.5 V12.5 H2.5 Z"), p("M8 7.5 V11"), p("M6.5 9.5 H9.5")],
  files: [r(3, 4.5, 7.5, 9), r(5.5, 2.5, 7.5, 9)],
  "volume-off": [p("M3.5 6.5 H6 L9 3.5 V12.5 L6 9.5 H3.5 Z"), p("M3 13 L13 3")],
  "mic-off": [r(6, 2.5, 4, 7), p("M4.5 8.5 V9.5 H11.5 V8.5"), p("M8 9.5 V13"), p("M6 13 H10"), p("M3 13 L13 3")],
  headphones: [p("M4 9 V12 H6 V9"), p("M10 9 V12 H12 V9"), p("M4 9 A4 4 0 0 1 12 9")],
  film: [
    r(2.5, 3.5, 11, 9),
    p("M5.5 3.5 V12.5"),
    p("M10.5 3.5 V12.5"),
  ...
  "wifi-off": [
    p("M3.5 8 A6 6 0 0 1 12.5 8"),
    p("M5 10 A4 4 0 0 1 11 10"),
    o(8, 13.2, 0.6),
    p("M3 13 L13 3"),
  ],
  layers: [
  ...
  "trending-up": [p("M2.5 11.5 L6.5 7.5 L9 10 L13.5 4.5"), p("M10.5 4.5 H13.5 V7.5")],
  "trending-down": [p("M2.5 4.5 L6.5 8.5 L9 6 L13.5 11.5"), p("M10.5 11.5 H13.5 V8.5")],
  compass: [o(8, 8, 5.5), p("M8 4 L9.2 9.2 L8 8 L6.8 9.2 Z")],
  map: [
  ...
  "thumbs-up": [p("M4 8 V13 H6.2 V8 Z"), p("M6.2 8 H12.2 L11.2 13 H6.2"), p("M7.5 8 V4.5 H9.5 L10 8")],
  slash: [p("M5 13 L11 3")],
