...
| `--ease` | `cubic-bezier(0.2, 0, 0, 1)` |  | `raster.ease` |  |
| `--duration-snap` | `0.12s` |  | `raster.durationSnap` |  |
| `--duration` | `0.18s` |  | `raster.duration` |  |
| `--duration-confirm` | `0.16s` |  | `raster.durationConfirm` |  |
| `--transition` | `background-color var(--duration) var(--ease), color var(--duration) var(--ease)` |  | `raster.transition` |  |
